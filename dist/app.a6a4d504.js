...
var _require = require('./helpers.js'),
    incrementQty = _require.incrementQty,
    decrementQty = _require.decrementQty,
    recalculateSubtotal = _require.recalculateSubtotal;
...
var subtotalText = document.querySelector('#subtotal');
...
incrButton.addEventListener('click', function () {
  ...
  subtotalText.textContent = "Rp. ".concat(recalculateSubtotal(priceInput.value, qtyInput.value, discount));
});
